...
namespace ct
{
    ...
    public slots:
        ...
        /**
         * @brief 计算AABB包围盒
         * 声明一个静态方法，静态成员函数可以被类的所有实例共享，而不需要实例化一个对象来调用它。
         */
         ...
         * ( Point Feature Histogram)点特征描述符
         */
        void PFHEstimation();

        /**
         * @brief 估计包含点和法线的给定点云数据集的快速点特征直方图(FPFH)描述符
         * （Fast Point Feature Histogram）快速点特征描述符
         */
        void FPFHEstimation();
         ...
         * (Ensemble of Shape Function) 描述子
         */
        void ESFEstimation();
        ...
        /**
         * @brief 估计包含点和法线的给定点云数据集的基于半径的曲面描述符（局部曲面曲线的最小和最大半径）
